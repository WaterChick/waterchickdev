<template>
  <svg viewBox="0 0 480 480" fill="none" xmlns="http://www.w3.org/2000/svg">
    <mask id="mask0_4945_373343" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="480" height="480">
      <rect width="480" height="480" fill="url(#paint0_radial_4945_373343)"/>
    </mask>
    <g mask="url(#mask0_4945_373343)">
      <g clip-path="url(#clip0_4945_373343)">
        <g clip-path="url(#clip1_4945_373343)">
        ...
        <g clip-path="url(#clip2_4945_373343)">
    ...
    <defs>
      <radialGradient id="paint0_radial_4945_373343" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(240 240) rotate(90) scale(240 240)">
        <stop/>
        <stop offset="1" stop-opacity="0"/>
      </radialGradient>
      <clipPath id="clip0_4945_373343">
        <rect width="480" height="480" fill="white"/>
      </clipPath>
      <clipPath id="clip1_4945_373343">
        <rect width="480" height="480" fill="white"/>
      </clipPath>
      <clipPath id="clip2_4945_373343">
        <rect width="480" height="480" fill="white"/>
      </clipPath>
    </defs>
  </svg>
